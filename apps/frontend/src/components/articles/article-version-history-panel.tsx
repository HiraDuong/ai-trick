	...
	return (
		<section className="space-y-4 rounded-[1.2rem] border border-[var(--color-line)] bg-white p-4">
			<div>
				...
				<p className="mt-1 text-sm text-[var(--color-muted)]">Select a snapshot to preview saved content.</p>
			</div>
						...
						{versions.length === 0 ? (
							...
							versions.map((version, index) => (
								...
								>
										...
										<p className="mt-1 font-semibold text-[var(--color-foreground)]">{version.updatedBy.name}</p>
